...
<body>
    ...
    ?>
        <table>
            ...
            ?>
                <tr>
                    <td><img src="<?php echo ($numImagen == $i) ? "camaleon/camaleon_$numImagen.png" : "camaleon/negro.png" ?>"></td>
                    <td><img src="<?php echo ($numImagen == ($i + 1)) ? "camaleon/camaleon_$numImagen.png" : "camaleon/negro.png" ?>"></td>
                    <td><img src="<?php echo ($numImagen == ($i + 2)) ? "camaleon/camaleon_$numImagen.png" : "camaleon/negro.png" ?>"></td>
                </tr>
            <?php
                $i += 3;
            }
